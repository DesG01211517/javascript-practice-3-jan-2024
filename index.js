...
for (let z = 0; z<4; z++){
  console.log(zooAnimals[z])

}
//console.log(`A ${zooAnimal[0]} lives in the zoo`);
//z++
//console.log(`A ${zooAnimal[1]} lives in the zoo`);
//z++
//console.log(`A ${zooAnimal[2]} lives in the zoo`);
//z++
//console.log(`A ${zooAnimal[3]} lives in the zoo`);
